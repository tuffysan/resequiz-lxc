...
app.get('/health',(req,res)=>res.json({ok:true,version:'2.3.1',rooms:rooms.size,questions:QUESTIONS.length,categories:CATEGORY_COUNTS}));
...
app.get('/api/questions/meta',(req,res)=>res.json({version:'2.3.1',questions:QUESTIONS.length,categories:CATEGORY_COUNTS,difficulties:['easy','medium','hard']}));
