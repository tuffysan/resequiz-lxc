...
app.get('/health',(req,res)=>res.json({ok:true,version:'2.0.0',rooms:rooms.size,questions:QUESTIONS.length,categories:CATEGORY_COUNTS}));
...
app.get('/api/questions/meta',(req,res)=>res.json({version:'2.0.0',questions:QUESTIONS.length,categories:CATEGORY_COUNTS,difficulties:['easy','medium','hard']}));
