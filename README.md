# Quiz 24.1.2 – Fullständigt Git/LXC-paket med faktagranskad produktionsbank
...
Efter installation: `/health` och `/api/meta` ska rapportera version 24.1.2. Installern skapar både ordinarie pre-upgrade-backup och en särskild `questions.json.pre-factreview-24.1.2-*.bak` innan frågebanken ändras.


## Quiz 24.1.2 – Verification Center
...
# Quiz 24.1.2 – Verification Center – Complete localization hotfix

## 24.1.2 – Complete UI localization
...
## 24.1.2 – Export av produktionsfrågebank
